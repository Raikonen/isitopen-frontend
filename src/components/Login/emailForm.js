...
import { validateEmail } from '../../actions/loginActions'
...
const EmailForm = (props) => {
    ...
    // Helper Functions
    const checkValidEmail = () => (email.length === 0 ? null : /^\w+([.-]?\w+)*@\w+([.-]?\w+)*(\.\w{2,3})+$/.test(email));
    ...
    const handleSubmit = async (event) => {
        ...
        if (!checkValidEmail()) {
            ...
            setError(null)
            await props.dispatch(validateEmail(email))
        }
    }
        ...
        <Modal.Dialog centered>
                ...
                <Container>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group controlId="email">
                            ...
                            <Form.Control
                                required name="email" onChange={handleChange} value={email} />
            ...
            <Modal.Footer>
                <Alert>
                    ...
                    <Alert.Link href="#" onClick={() => props.history.push('/signup')}>
                        Sign Up Here!
            </Alert.Link>
                </Alert>
            </Modal.Footer>
